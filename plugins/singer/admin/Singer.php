...
class Singer extends Cscms_Controller {
	...
	public function index(){
        ...
        $sql_string = "SELECT id,name,pic,hits,reco,cid,addtime FROM ".CS_SqlPrefix.$table." where 1=1";
	...
	public function save(){
        ...
        if(!empty($user)){
            $us = $this->db->query("SELECT id FROM ".CS_SqlPrefix."user WHERE name='".$user.".");
        }else{
            $data['uid'] = 0;
        }
